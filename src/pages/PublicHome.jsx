...
import { Send, Github, Linkedin, Globe, FileText } from 'lucide-react';
import VoiceRecordButton from '../components/VoiceRecordButton';
import AudioAnswerPlayer from '../components/AudioAnswerPlayer';
...
const PublicHome = () => {
    ...
    const fetchProfile = async () => {
        try {
            const res = await axios.get('/api/public/getData');
            setProfile(res.data);
        } catch (error) {
    ...
    const handleAsk = async (textOverride) => {
        ...
        try {
            const res = await axios.post('/api/public/ask', {
                question: q,
